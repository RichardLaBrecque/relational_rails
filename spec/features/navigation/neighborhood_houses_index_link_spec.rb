...
describe 'Sort Neighborhood Houses Index alphabetically' do
    ...
    it 'can sort Houses Index alphabetically' do
      ...
      expect(@ammon.family_name).to appear_before(@ann.family_name)
      expect(@ann.family_name).to appear_before(@dowis.family_name)
      expect(@dowis.family_name).to appear_before(@fleur.family_name)
      expect(@fleur.family_name).to appear_before(@john.family_name)
      expect(@john.family_name).to appear_before(@lemon.family_name)
      expect(@lemon.family_name).to appear_before(@sam.family_name)
      expect(@sam.family_name).to appear_before(@sasha.family_name)
      expect(@sasha.family_name).to appear_before(@tamara.family_name)
      expect(@tamara.family_name).to appear_before(@tenzin.family_name)
    end
  end
end
end
